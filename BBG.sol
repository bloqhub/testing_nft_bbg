...
contract BornBadGirls is ERC721Enumerable, Ownable, Pausable  {
    using Strings for uint256;
    ...
    uint256 public constant NB_TEAM_NFT = 200;

    constructor() ERC721("BornBadGirls", "BBG") {
        _baseURIextended = "https://api.bornbadgirls.com/meta/";

        // 0.3 BNB
        _price1extended = 300000000000000000;
    ...
    */
    function claimNFT() public onlyOwner {
        require(totalSupply() < MAX_NFT_SUPPLY, "Sale has already ended");
        require(totalSupply() < NB_TEAM_NFT, "200 BornBadGirls for the team");
   ...
   /**
    * @dev Mints 10 NFT For Free
    */
    function claim10NFT() public onlyOwner {
        uint256 numberOfNfts = 10;
        require(totalSupply().add(numberOfNfts) <= MAX_NFT_SUPPLY, "Exceeds max nft supply");
        require(totalSupply().add(numberOfNfts) <= NB_TEAM_NFT, "200 BornBadGirls for the team");

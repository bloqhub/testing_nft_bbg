...
contract BornBadGirls is ERC721Enumerable, Ownable, Pausable  {
    ...
    constructor() ERC721("Bloqhub Christmas Token. TESTNET", "BCTT") {
        _baseURIextended = "https://testnet-nft-api.bloqhub.net/meta/";


        _price1extended = 100000000000000000;
    ...
    */
    ...
    /**
     * @dev Withdraw from this contract (Callable by owner)
    */
